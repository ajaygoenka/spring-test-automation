...
import com.experian.test.api.SurveyApi;
...
public class SurveyStepDefinition {
    ...
    private static final Logger log = (Logger) LoggerFactory.getLogger(SurveyStepDefinition.class);
    ...
    @Given("^I create a new (internal experian|external experian) survey service request to the (.*) endpoint$")
    public void create_new_api_request(String intOrExt, String endpoint) throws Throwable {
        surveyApi.setBaseUrl(endpoint, intOrExt);
        commonStepDefinition.setApiObject(surveyApi);
    }
