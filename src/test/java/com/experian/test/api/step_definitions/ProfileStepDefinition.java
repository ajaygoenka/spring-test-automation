...
import com.experian.test.api.ProfileApi;
...
public class ProfileStepDefinition {
    ...
    private static final Logger log = (Logger) LoggerFactory.getLogger(ProfileStepDefinition.class);
    ...
    @Given("^I create a new (internal experian|external experian) profile service request to the (.*) endpoint$")
    public void create_new_api_request(String intOrExt, String endpoint) throws Throwable {
        profileApi.setBaseUrl(endpoint, intOrExt);
        commonStepDefinition.setApiObject(profileApi);
    }
