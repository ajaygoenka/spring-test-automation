...
@Component
@Scope("cucumber-glue")
public class ProfileApi extends AbstractApiObject {

    private static final Logger log = (Logger) LoggerFactory.getLogger(ProfileApi.class);
    ...
    public void setBaseUrl(String endpoint, String intOrExt) {
        ...
        if (intOrExt.equalsIgnoreCase("internal experian") && endpoint.contains("{customerId}")) {
            ...
            baseUrl = envSetup.getProfileUrl() + "/internal" + endpoint;
        ...
        API_VERSION_NUMBER = envSetup.getProfileApiVersion();
    ...
    public void setJsonObject(JSONObject jsonStr) {
        jsonObject = jsonStr;
    }
