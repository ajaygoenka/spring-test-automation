...
@Component
@Scope("cucumber-glue")
public class ClickstreamApi extends AbstractApiObject {
    private static final Logger log = (Logger) LoggerFactory.getLogger(ClickstreamApi.class);
    ...
    public void setBaseUrl(String endpoint, String intOrExt) {
        if (intOrExt.equalsIgnoreCase("internal experian") && endpoint.contains("{marketingId}")){
            ...
            baseUrl = envSetup.getClickstreamUrl() + "/internal" + endpoint;
        ...
        API_VERSION_NUMBER = envSetup.getClickstreamApiVersion();
