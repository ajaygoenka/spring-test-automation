...
@Component
@Scope("cucumber-glue")
public class UiProfileApi extends AbstractApiObject {

    private static final Logger log = (Logger) LoggerFactory.getLogger(UiProfileApi.class);
