...
@Component
@Scope("cucumber-glue")
public class BureaulockApi extends AbstractApiObject {
    private static final Logger log = (Logger) LoggerFactory.getLogger(BureaulockApi.class);
    ...
    public void setBaseUrl(String endpoint, String intOrExt) {
        if (intOrExt.equalsIgnoreCase("internal experian")&& endpoint.contains("{customerId}")) {
            ...
            baseUrl = envSetup.getBureauLockUrl() + "/internal" + endpoint;
        ...
        API_VERSION_NUMBER = envSetup.getBureauLockApiVersion();
